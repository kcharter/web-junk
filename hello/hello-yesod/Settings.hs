...
-- declared in the hello-yesod.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
-- See config/Hello.hs for command line arguments
...
--
-- If you change the resource pattern for StaticR in hello-yesod.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in hello-yesod.hs
